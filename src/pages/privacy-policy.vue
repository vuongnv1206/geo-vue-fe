<template>
  <VaLayout class="h-screen bg-[var(--va-background-secondary)]">
    ...
    <template #content>
      ...
      <main class="h-[calc(100%-40px)] flex items-center justify-center mx-auto max-w-[100%]">
        <VaScrollContainer class="max-h-[90vh]" vertical>
          <div class="flex flex-col items-start gap-6 px-4 my-8">
            <h1>Privacy Policy</h1>
            <p>Updated at 2024-07-23</p>

            <p>
              GEO (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your
              personal information is collected, used, and disclosed by GEO.
            </p>
            <p>
            ...
            <p>
              ...
              characteristics — is collected automatically when you visit our platform. This information may be used to
              connect your computer to the Internet. Other information collected automatically could be a login, e-mail
              address, password, computer and connection information such as browser plug-in types and versions and time
              zone setting, operating systems and platforms, purchase history, (we sometimes aggregate with similar
              information from other Users), the full Uniform Resource Locator (URL) clickstream to, through and from
              our Website that may include date and time; cookie number; parts of the site you viewed or searched for;
              and the phone number you used to call our Customer Services. We may also use browser data such as cookies,
              Flash cookies (also known as Flash Local Shared Objects) or similar data on certain parts of our Website
              for fraud prevention and other purposes. During your visits, we may use software tools such as JavaScript
              to measure and collect session information including page response times, download errors, length of
              visits to certain pages, page interaction information (such as scrolling, clicks, and mouse-overs), and
              methods used to browse away from the page. We may also collect technical information to help us identify
            ...
            <p>
              ...
              when you use our and other technical information. This information is primarily needed to maintain the
              security and operation of our platform, and for our internal analytics and reporting purposes.
            </p>
            ...
            <h1>Governing Law</h1>
            <p>
              This Privacy Policy is governed by the laws of Viet Nam without regard to its conflict of laws provision.
            ...
            <p>
              The laws of Viet Nam, excluding its conflicts of law rules, shall govern this Agreement and your use of
            ...
            <p>
              ...
              please contact Us. If We become aware that We have collected Personal Data from anyone under the age of 13
            ...
            <p>
              ...
              be bound by the updated Privacy Policy. If you do not want to agree to this or any updated Privacy Policy,
            ...
            <p>
              We may be collecting and using information from you if you are from the European Economic Area (EEA), and
              in this section of our Privacy Policy we are going to explain exactly how and why is this data collected,
            ...
            <p>
              ...
              information that could be used on its own, or in combination with other pieces of information, to identify
              a person. Personal data extends beyond a person’s name or email address. Some examples include financial
            ...
            <ul>
              <li>
                Personal data collected must be processed in a fair, legal, and transparent way and should only be used
            ...
            <p>
              ...
              service from the start and have always given you access to your data and your customers data. Our customer
              support team is here for you to answer any questions you might have about working with the API.
            </p>
            ...
            <p>Via Email: nguyenvancaoky@gmail.com</p>
          </div>
        </VaScrollContainer>
      </main>
    </template>
